<template>
    <app-layout title="Dashboard">
        ...
        <!--Formulario de Asignación de Material-->
        <section v-if="window==1" class="border-gray-900 max-w-4xl mx-auto bg-gray-300 rounded-md shadow-md dark:bg-gray-800 mt-2">
            <div class="pt-1 pr-1 flex justify-end">
                <button title="Cerrar" @click="downRegisterAssign" class="hover:scale-110 px-1 place-items-center leading-5 text-white transition-colors duration-200 transform rounded-md hover:bg-gray-400 focus:outline-none focus:bg-gray-600">
            ...
            <form class="pl-6 pb-6 pr-6">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select v-model="nameCateg" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            ...
            <div v-if="window==0" class="overflow-x-auto">
                    <div class="min-w-screen min-h-screen flex items-start justify-center font-sans overflow-hidden">
                        ...
                        <div @click="openRegisterAssign" class="pt-1.5 inline-block mr-2 mt-2">
                            <button type="button" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-gradient-to-r from-blue-400 to-blue-600 transform hover:scale-110">Asignar Nuevo Material</button>
                        </div>
                        <!--Fin del Boton-->
                            <div class="bg-white shadow-md rounded my-6">
                                <table class="min-w-auto w-auto table-auto">
                                    ...
                                    <tbody class="text-gray-600 text-sm font-light">
                                        <tr v-for="(objeto, index) in arrayDatosAssign" :key="index" class="border-b border-gray-200 hover:bg-gray-100">

                                            <td class="py-3 px-6 text-center">
                                                <span  v-text="objeto.date" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs"></span>
                                            </td>

                                            <td class="py-3 px-6 text-center">
                                                <span  v-text="objeto.nameRol" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs"></span>
                                            </td>

                                            <td class="py-3 px-6 text-center">
                                                <span  v-text="objeto.nameCharg" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs"></span>
                                            </td>

                                            <td class="py-3 px-6 text-center">
                                                <span  v-text="objeto.nameNav" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs"></span>
                                            </td>
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center">
                                                    ...
                                                    <div @click="(objeto)" class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110" title="Editar">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                                        </svg>
                                                    </div>
                                                    <div @click="(objeto)" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110" title="Eliminar">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                        </svg>
                                                    </div>
...
<script>
    ...
    export default defineComponent({
        ...
        mounted(){
            ...
            this.listarDatosCat();
            this.listarDatosMat();
            this.listarDatosAssign();
        },
        data() {
            return {
                window:0, //1: Tabla 0: Nuevo Registro
                titulo:"",
        ...
        methods: {
            listarDatosAssign(){
                let me=this;
                var url="/api/assign/index2";
                axios.get(url)
                .then(function(response){
                    var respuesta=response.data;
                    me.arrayDatosAssign=respuesta.assign;
