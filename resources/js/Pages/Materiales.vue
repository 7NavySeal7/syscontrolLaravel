                                ...
                                <div class="bg-white shadow-md rounded my-6">
                                    <table class="min-w-auto w-auto table-auto">
                                        ...
                                        <tbody class="text-gray-600 text-sm font-light">
                                            <tr v-for="(objeto, index) in material" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                                    <div v-text="objeto.code" class="flex items-center">
                                                ...
                                                <td class="py-3 px-6 text-center">
                                                    <span v-text="objeto.categname" class="bg-green-200 text-purple-600 py-1 px-3 rounded-full text-xs">Administrador</span>
                                                </td>
                                                <td class="py-3 px-6 text-center">
                                                    <div v-text="objeto.description" class="flex items-center justify-start">
