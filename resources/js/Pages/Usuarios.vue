                ...
                USUARIOS REGISTRADOS
                    ...
                    <section v-if="window==0" class="max-w-4xl mx-auto bg-indigo-300 rounded-md shadow-md dark:bg-gray-800 mt-2">
                        <div class="pt-1 pr-1 flex justify-end">
                            <button title="Cerrar" @click="downRegister" class="hover:scale-110 px-1 place-items-center leading-5 text-black transition-colors duration-200 transform rounded-md hover:bg-indigo-500 focus:outline-none focus:bg-gray-600">
                        ...
                        <h1 class="text-xl font-bold text-black uppercase dark:text-white">{{titulo}}</h1>
                            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                                ...
                                <div>
                                    <label class="text-white dark:text-gray-200" for="surname">Apellido</label>
                                ...
                                <div>
                                    <label class="text-white dark:text-gray-200" for="phone">Telefono</label>
                                ...
                                <div>
                                    <label class="text-white dark:text-gray-200" for="rol">Rol</label>
                                    <select v-model="rol" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                ...
                                <div>
                                    <label class="text-white dark:text-gray-200" for="charge">Cargo</label>
                                    <select v-model="cargo" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                        <option value="1">Desarrollador</option>
                                        <option value="2">Ingeniero Electricista</option>
                                    </select>
                                </div>
                    ...
                    <div v-else class="overflow-x-auto">
                        <div class="min-w-screen min-h-screen flex items-start justify-center font-sans overflow-hidden">
                            ...
                            <div class="pt-1.5 inline-block mr-2 mt-2">
                                <button @click="openRegister" type="button" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-gradient-to-r from-blue-400 to-blue-600 transform hover:scale-110">
                                    Nuevo Registro
                                </button>
                            </div>
                            <!--Fin del Boton-->
                                <div class="bg-white shadow-md rounded my-6">
                                    <table class="min-w-auto w-auto table-auto">
                                        ...
                                        <tbody class="text-gray-600 text-sm font-light">
                                            <tr v-for="(objeto, index) in this.arrayDatos" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-6 text-center">
                                                    <span v-if="objeto.id_roles==1" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs">Administador</span>
                                                    <span v-else-if="objeto.id_roles==2" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs">Usuario</span>
                                                </td>

                                                <td class="py-3 px-6 text-center">
                                                    <span v-if="objeto.id_charge==1" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs">Desarrollador</span>
                                                    <span v-else-if="objeto.id_charge==2" class="bg-blue-200 text-purple-600 py-1 px-3 rounded-full text-xs">Ingeniero Electricista</span>
                                                </td>
                                                <td class="py-3 px-6 text-center">
        ...
        methods: {
            ...
            listarDatos(){
                ...
                .then(function(response){
                    ...
                    me.arrayDatos=respuesta.usuarios;
                })
...
//Actualizar
            ...
            updateRegister(data=[]){
                ...
                this.rol=data['id_roles'];
                this.cargo=data['id_charge'];
