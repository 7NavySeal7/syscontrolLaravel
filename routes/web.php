...
Route::get('/api/cities/index',[CitiesController::class,'index']); //true
...
Route::get('/api/departaments/index',[DepartamentController::class,'index']); //true
...
Route::get('/api/countries/index',[CountryController::class,'index']); //true
...
Route::get('/api/roles/index',[RolesController::class,'index']); //true
...
Route::get('/api/charges/index',[ChargesController::class,'index']); //true
